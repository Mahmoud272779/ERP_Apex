...
namespace App.Domain.Models.Security.Authentication.Response.Store
{
   ...
   public class Purchases
    ...
    public class POS
    {
        ...
        public int Pos_ModifyPricesType { get; set; }
    ...
    public class Sales
    {
        ...
        public  int Sales_ModifyPricesType { get; set; }
    ...
    public class Other
    {
        ...
        public bool other_ActivatePriceLists { get; set; }
        public int PriceListType { get; set; }
        public bool? isExpenses { get; set; } // مصروفات
        public bool other_AlertMessageForCustomerSupplierBalance { get; set; } //رسالة تنبيه ان العميل او المورد له رصيد
        public bool other_AutoExtractFromCustomerSupplierBalance { get; set; } //السحب الالى من رصيد العميل او المورد
        public bool other_DoNothingForCustomerSupplierBalance { get; set; } //لاتفعل شىء
    }
    ...
    public class PriceListResponse
    {
        ...
        public bool PersonPrice { get; set; }
        public bool UserPrice { get; set; }
        public bool BranchPrice { get; set; }
        public bool SalesManPrice { get; set; }
        public bool LastPriceForCustomer { get; set; }
    }
}
