...
namespace App.Infrastructure.Migrations
{
    ...
    [Migration("20240218103342_UsersOtherSettings-PurchasesAllowEditJournalEntry")]
    partial class UsersOtherSettingsPurchasesAllowEditJournalEntry
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App.Domain.Entities.GlReciepts", b =>
                {
                    ...
                    b.Property<int?>("MultiCollectionReceiptParentId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("App.Domain.Entities.otherSettings", b =>
                {
                    ...
                    b.Property<bool>("PurchasesPaymentFromInsideInvoice")
                        .HasColumnType("bit");

                    b.Property<bool>("PurchasesallowEdidJournalEntry")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("purchaseShowAllPersonBalance")
                        .HasColumnType("bit");

                    b.Property<bool>("purchaseShowBalanceOfPerson")
                        .HasColumnType("bit");

                    b.Property<bool>("purchaseShowCreditorPersonBaalance")
                        .HasColumnType("bit");

                    b.Property<bool>("purchaseShowDebitorPersonBalance")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("salesPaymentFromInsideInvoice")
                        .HasColumnType("bit");

                    b.Property<bool>("salesShowAllPersonBalance")
                        .HasColumnType("bit");

                    b.Property<bool>("salesShowBalanceOfPerson")
                        .HasColumnType("bit");

                    b.Property<bool>("salesShowCreditorPersonBaalance")
                        .HasColumnType("bit");

                    b.Property<bool>("salesShowDebitorPersonBalance")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("App.Domain.Entities.Process.GLGeneralSetting", b =>
                {
                    ...
                    b.Property<bool>("AddDiscountInJournalEntryForInvoics")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("App.Domain.Entities.Process.GLJournalEntry", b =>
                {
                    ...
                    b.Property<DateTime?>("lastTimeProfitCalced")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("App.Domain.Entities.Process.InvGeneralSettings", b =>
                {
                    ...
                    b.Property<int>("Pos_ModifyPricesType")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("Sales_ModifyPricesType")
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("other_ActivatePriceLists")
                        .HasColumnType("bit");

                    b.Property<bool>("other_AlertMessageForCustomerSupplierBalance")
                        .HasColumnType("bit");

                    b.Property<bool>("other_AutoExtractFromCustomerSupplierBalance")
                        .HasColumnType("bit");

                    b.Property<bool>("other_DoNothingForCustomerSupplierBalance")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("App.Domain.Entities.Process.InvoiceDetails", b =>
                {
                    ...
                    b.Property<double>("VatValueForPrint")
                        .HasColumnType("float");
                    ...
                    b.Property<bool>("isDiscountRatioItem")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("App.Domain.Entities.Process.InvoiceMaster", b =>
                {
                    ...
                    b.Property<bool>("isDiscountRatio")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("App.Domain.Entities.Process.InvoiceMasterHistory", b =>
                {
                    ...
                    b.Property<int?>("MultiCollectionReceiptsId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("App.Domain.Entities.Process.InvPersons", b =>
                {
                    ...
                    b.Property<int?>("FundsCustomerSuppliersId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("FundsCustomerSuppliersId");
            ...
            modelBuilder.Entity("App.Domain.Entities.Process.Store.EInvoice.CSID", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("cSIDKey")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("cSR")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("error_ar")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("error_en")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("App.Domain.Entities.Process.InvFundsCustomerSupplier", b =>
                {
                    b.HasOne("App.Domain.Entities.Process.GLBranch", "branch")
                        .WithMany("FundsCustomerSupplier")
                        .HasForeignKey("branchId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("App.Domain.Entities.Process.InvPersons", b =>
                {
                    ...
                    b.HasOne("App.Domain.Entities.Process.InvFundsCustomerSupplier", "FundsCustomerSuppliers")
                        .WithMany("Person")
                        .HasForeignKey("FundsCustomerSuppliersId")
                        .OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity("App.Domain.Entities.Process.GLBranch", b =>
                {
                    ...
                    b.Navigation("FundsCustomerSupplier");
